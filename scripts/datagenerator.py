...
# from tensorflow.contrib.data import Dataset   # Stop use after tf v1.3
...
class ImageDataGenerator(object):
    ...
    def __init__(self, txt_file, mode, batch_size, num_classes, shuffle=True,
        ...
        # create dataset
        data = tf.data.Dataset.from_tensor_slices((self.img_paths, self.labels)) # use tf.data.Dataset
    ...
    def _parse_function_train(self, filename, label):
        ...
        # ----------------------------------------
        # For gray image
        img_bgr = tf.concat([img_resized, img_resized, img_resized], 2)
